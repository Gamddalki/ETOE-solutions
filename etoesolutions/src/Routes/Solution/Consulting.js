  ...
  return (
    <>
      <BodyWrapper pageTitle="컨설팅" pageSubtitle="Technical Consulting">
        ...
        <span>
          ৹ 고객 비즈니스와 운영 환경을 이해하는 전담팀에 의한 서비스 <br />
          ৹ 제품 분야별 전문가 조직에 의한 시스템 최적화 진단을 통한 고객 시스템
          가용성 극대화
          <br />
          ৹ 효과적인 소프트웨어 버전 관리 및 패치 적용으로 시스템 장애를 최대한
          사전에 예방 <br />
          ৹ 전담팀 및 후선 지원 조직에 의한 신속한 문제 해결
          <br />
          ৹ 신기술 및 IT 솔루션 전수로 운영 능력 향상
          <br />
        </span>
      </BodyWrapper>
    </>
